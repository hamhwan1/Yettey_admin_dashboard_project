  ...
  return (
    <DashboardLayout>
      <PageHeader
        ...
        actions={<AdminButton variant="primary"><Plus className="size-4" />Create Plan</AdminButton>}
      />
      <section className="mb-8 rounded-2xl border border-slate-200 bg-white p-6 shadow-[0_1px_2px_rgba(15,23,42,0.06),0_12px_32px_rgba(15,23,42,0.04)]">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <button className="rounded-lg px-3 py-2 text-sm font-semibold text-slate-500 transition hover:bg-slate-100 hover:text-slate-950" onClick={() => setStatus("All")}>
            Reset All
          </button>
        </div>
      </section>
