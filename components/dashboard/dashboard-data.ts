...
export const overviewKpis = [
  {
    ...
    insight: "YouTube and referral cohorts are driving the highest quality sessions.",
  ...
  },
  {
    ...
    insight: "Exported-content users are returning more reliably than browse-only users.",
  ...
  },
  {
    ...
    ctaLabel: "Open subscription analytics",
  },
  {
    label: "Revenue",
    value: "$286.4K",
  ...
  },
  {
    ...
    insight: "Accounts above 75% credit usage are likely upgrade candidates.",
  ...
  },
  {
    ...
    insight: "First project creation remains the key activation checkpoint.",
    href: "/dashboard/intelligence/funnel?stage=First%20Project%20Created",
    ctaLabel: "Open project funnel",
  },
  {
    label: "AI Jobs",
    value: "684,920",
    detail: "96.8% completed",
    insight: "Peak VPICK windows are starting to pressure queue latency.",
    href: "/dashboard/intelligence/ai-operations",
    ctaLabel: "View AI job operations",
  },
]
